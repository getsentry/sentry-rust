...
[`sentry::init`]: https://docs.rs/sentry/0.48.3/sentry/fn.init.html
[`Hub`]: https://docs.rs/sentry/0.48.3/sentry/struct.Hub.html
...
[Features]: #features
[integrations]: https://docs.rs/sentry/0.48.3/sentry/integrations/index.html
[apply_defaults]: https://docs.rs/sentry/0.48.3/sentry/fn.apply_defaults.html
...
[`Integration`]: https://docs.rs/sentry/0.48.3/sentry/trait.Integration.html
[`Transport`]: https://docs.rs/sentry/0.48.3/sentry/trait.Transport.html
...
### Metrics
- `metrics`: Enables [`sentry::metrics`](https://docs.rs/sentry/0.48.3/sentry/crate::metrics) APIs for counters, gauges, and
  distributions.
