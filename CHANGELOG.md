...
- Added [`EnvelopeItem::losses_on_drop`](https://docs.rs/sentry-types/latest/sentry_types/protocol/v7/enum.EnvelopeItem.html#method.losses_on_drop), which lets transports determine the client report data categories and quantities to report when envelope items are dropped ([#1170](https://github.com/getsentry/sentry-rust/pull/1170)).
