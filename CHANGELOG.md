...
- Added the [`LossSource`](https://docs.rs/sentry-types/latest/sentry_types/protocol/v7/client_report/trait.LossSource.html) trait, which provides the client report data categories and quantities to report when supported Sentry data is dropped ([#1170](https://github.com/getsentry/sentry-rust/pull/1170)).
