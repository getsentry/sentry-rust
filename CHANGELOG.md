...
- Added [`EnvelopeFilter`](https://docs.rs/sentry-types/latest/sentry_types/protocol/v7/trait.EnvelopeFilter.html) and [`EnvelopeFilterCallbacks`](https://docs.rs/sentry-types/latest/sentry_types/protocol/v7/struct.EnvelopeFilterCallbacks.html), which let callers observe envelope items removed by [`Envelope::filter`](https://docs.rs/sentry-types/latest/sentry_types/protocol/v7/struct.Envelope.html#method.filter), including attachments removed after their event or transaction is filtered out. Existing `Envelope::filter` closure callers continue to work, although some closures may require an explicit item type annotation ([#XXXX](https://github.com/getsentry/sentry-rust/pull/XXXX)).
- Added [`Envelope::losses_on_drop`](https://docs.rs/sentry-types/latest/sentry_types/protocol/v7/struct.Envelope.html#method.losses_on_drop) and [`EnvelopeLossIter`](https://docs.rs/sentry-types/latest/sentry_types/protocol/client_report/struct.EnvelopeLossIter.html), which let transports determine the client report data categories and quantities to report when an envelope is dropped ([#1170](https://github.com/getsentry/sentry-rust/pull/1170)).
